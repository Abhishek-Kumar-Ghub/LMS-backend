...
const getMyCourses=async(req , res)=>{
    try {
          ...
          //courseId se saare feild(title subtitle thumbnailUrl instructor) select krega then it is nested populaated --> instructor k multiple courses so y course ka naam leke aa rha
